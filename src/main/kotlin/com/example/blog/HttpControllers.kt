...
class ProductController(private val repository: ProductRepository) {
    ...
    fun insert(): Response<Product> {
        ...
        repository.save(Product(
                ...
                price = 4600000000,
                thumbnail = "/images/VinFastPresident2021.jpg",
                rate = 4.5f,
        ...
        repository.save(Product(
                ...
                price = 46113000000,
                thumbnail = "/images/rolls-royce-phantom.webp",
                rate = 5f,
        ...
        repository.save(Product(
                ...
                price = 880000000,
                thumbnail = "/images/Mercedes-Benz-VISION-AVTR.jpg",
                rate = 5f,
        ...
        repository.save(Product(
                ...
                price = 1835693000,
                thumbnail = "/images/VinFast-VFe34-gray.jpg",
                rate = 4.5f,
        ...
        repository.save(Product(
                ...
                price = 2200000000,
                thumbnail = "/images/Mercedes-Benz-EQG.webp",
                rate = 5f,
        ...
        repository.save(Product(
                ...
                price = 7850000000,
                thumbnail = "/images/Porsche-911.jpg",
                rate = 5f,
        ...
        repository.save(Product(
                ...
                price = 4350000000,
                thumbnail = "/images/Porsche-959.jpg",
                rate = 5f,
        ...
        repository.save(Product(
                ...
                price = 1499000000,
                thumbnail = "/images/MERCEDES-BENZ_C300.jpg",
                rate = 4f,
